...
impl OpenAIChatService {
    pub fn frontend() -> Arc<ServiceFrontend<SingleIn<ChatCompletionRequest>, ManyOut<Annotated<ChatCompletionResponseDelta>>>> {
        ServiceFrontend::new()
    }

    pub fn segment_source() -> Arc<SegmentSource<SingleIn<ChatCompletionRequest>, ManyOut<Annotated<ChatCompletionResponseDelta>>>> {
        SegmentSource::new()
    }

    pub fn segment_sink() -> Arc<SegmentSink<SingleIn<ChatCompletionRequest>, ManyOut<Annotated<ChatCompletionResponseDelta>>>> {
        SegmentSink::new()
    }
}
