...
//     #[test]
//     fn test_validate_and_collect_chat_messages() {
//         let messages = vec![
//             v1::chat_completion::ChatCompletionMessage {
...
//             v1::chat_completion::ChatCompletionMessage {
//                 role: MessageRole::assistant,
//                 content: Content::Text("I'm fine".to_string()),
//             },
//         ];
//         let context = validate_and_collect_chat_messages(messages).unwrap();
//         assert_eq!(context.completion.prompt, "How are you?");
//         assert_eq!(context.completion.system_prompt, None);
//         assert_eq!(context.context.len(), 2);
//         assert_eq!(context.context[0].user, "Hello");
//         assert_eq!(context.context[0].assistant, "Hi");
//         assert_eq!(context.context[1].user, "How are you?");
//         assert_eq!(context.context[1].assistant, "I'm fine");
//     }

//     #[test]
//     fn test_validate_and_collect_chat_messages_with_system_prompt() {
//         let messages = vec![
//             v1::chat_completion::ChatCompletionMessage {
//                 role: MessageRole::system,
//                 content: Content::Text("System prompt".to_string()),
//             },
//             v1::chat_completion::ChatCompletionMessage {
//                 role: MessageRole::user,
//                 content: Content::Text("Hello".to_string()),
