...
from compoundai import depends, nova_endpoint, service, api, server_context

from vllm.engine.arg_utils import AsyncEngineArgs
from vllm.utils import FlexibleArgumentParser

# This decorator allows you to run decode with DP using `workers=X`
@service(
    nova={
        "enabled": True,
...
class Decode:
    ...
    def __init__(self):
        os.environ["CUDA_VISIBLE_DEVICES"] = f"{server_context.worker_index - 1},{server_context.worker_index - 2}"
