...
# Start the container
srun \
    --container-mounts=/lustre/share/:/lustre/share/,/lustre/fsw/:/lustre/fsw/ \
    ...
    --load-value 1 2 4 8 16 32 64 128 256 512 1024 2048 4096 \
    --request-count-per-load-value 10 \
    --min-request-count 20 \
    --artifact-dir /lustre/fsw/coreai_tritoninference_triton3/ptarasiewicz/src/triton-3/examples/vllm/artifacts/avoid_memcpy_generate/